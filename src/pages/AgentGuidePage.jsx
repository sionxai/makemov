        ...
        <div className="agent-guide-page">
            ...
            <header className="agent-hero">
                ...
                <div className="agent-hero-links">
                    <a href="#instructions" className="agent-btn-primary">🤖 에이전트 지침</a>
                    <a href="#schemas" className="agent-btn-secondary">📐 데이터 스키마</a>
                    <a href="#examples" className="agent-btn-secondary">💡 빠른 예제</a>
                </div>
            </header>

            {/* ── Agent Instructions ────────────── */}
            <Section icon="🤖" title="AI 에이전트용 지침 (AGENT INSTRUCTIONS)" id="instructions">
